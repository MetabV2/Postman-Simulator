...
BtnText_2.Text = "INFINITE ENERGY"
...
local function VXIXN_fake_script() -- ImageLabel.LocalScript 
...
coroutine.wrap(VXIXN_fake_script)()
local function ZIVSYV_fake_script() -- ImageLabel.LocalScript 
	local script = Instance.new('LocalScript', ImageLabel)
...
coroutine.wrap(ZIVSYV_fake_script)()
local function LZLM_fake_script() -- Button1.ANIME 
...
coroutine.wrap(LZLM_fake_script)()
local function JJSNKI_fake_script() -- Button1.METAB SCRIPT 
	local script = Instance.new('LocalScript', Button1)
...
coroutine.wrap(JJSNKI_fake_script)()
local function PVIQSCY_fake_script() -- Button2.Button7Script 
...
coroutine.wrap(PVIQSCY_fake_script)()
local function MNLPBDD_fake_script() -- Button2.METAB SCRIPT 
	local script = Instance.new('LocalScript', Button2)
	...
	script.Parent.MouseButton1Down:connect(function()
		...
		_G.CoinTP = true
		while _G.CoinTP and wait() do	    	
			game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").FinishLines.Lava.CFrame
			fireproximityprompt(game:GetService("Workspace").Hats.Space.UFO.ProximityPrompt)
			wait()
			game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(5.2042899131775, -95.24821472168, 491.52560424805)
...
coroutine.wrap(MNLPBDD_fake_script)()
local function HBOMW_fake_script() -- Button3.ANIME 
...
coroutine.wrap(HBOMW_fake_script)()
local function FUDIEQC_fake_script() -- Button3.METAB SCRIPT 
	local script = Instance.new('LocalScript', Button3)

	
	script.Parent.MouseButton1Down:connect(function()
	
		game:GetService("Players").LocalPlayer.Gamepasses.EggSkip.Value = true
	end)
...
coroutine.wrap(FUDIEQC_fake_script)()
local function OUURQ_fake_script() -- CloseButton.LocalScript 
...
coroutine.wrap(OUURQ_fake_script)()
local function WKCHR_fake_script() -- CloseButton.ANIME 
	local script = Instance.new('LocalScript', CloseButton)
...
coroutine.wrap(WKCHR_fake_script)()
local function LKGOCRT_fake_script() -- ImageButton.LocalScript 
...
coroutine.wrap(LKGOCRT_fake_script)()
